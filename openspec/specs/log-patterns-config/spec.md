...
#### Scenario: RGB triple converted to BGR
- **WHEN** a rule specifies `MAKE_BGR(220, 0, 0)`
- **THEN** the resulting `COLORREF` is `0x0000DC`, so Scintilla renders the rule in red rather than in blue
